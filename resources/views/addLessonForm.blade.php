...
@section('title-page', 'Добавление урока')
...
@section('addDirectionPage')
    <div class="start">
        <div class="addDirectionPage__container _container">
            ...
            <form action="{{ route('addLesson', ['course' => $course->id]) }}" class="addDirectionPage__form" method="post">
                @csrf
                <div class="right-form__item">
                    <label for="title_lesson" class="right-form__label">Название урока</label>
                    <input maxlength="255" value="{{ old('title_lesson') }}" type="text" id="title_lesson" name="title_lesson" class="right-form__inp" autocomplete="title_lesson">
                    @error('title_lesson')
                ...
                <div class="right-form__item">
                    ...
                    <input maxlength="255" value="{{ old('short_desc_lesson') }}" type="text" id="short_desc_lesson" name="short_desc_lesson" class="right-form__inp" autocomplete="short_desc_lesson">
                ...
                <div class="right-form__item">
                    ...
                    <textarea class="right-form__textarea" name="big_desc_lesson" id="big_desc_lesson">{{ old('big_desc_lesson') }}</textarea>
                ...
                <div class="right-form__item">
                    ...
                    <textarea class="right-form__textarea" name="theme_text_lesson" id="theme_text_lesson">{{ old('theme_text_lesson') }}</textarea>
                ...
                <div class="right-form__item">
                    ...
                    <textarea class="right-form__textarea" name="training_lesson" id="training_lesson">{{ old('training_lesson') }}</textarea>
                ...
                <div class="right-form__item">
                    ...
                    <textarea class="right-form__textarea" name="conclusion_lesson" id="conclusion_lesson">{{ old('conclusion_lesson') }}</textarea>
